            ...
            <div className="flex justify-between flex-wrap">
                <div className="md:w-[35% w-full] mr-[5%] pt-8">
                    ...
                    <div className="flex bg-white items-center p-[1px] rounded">
                        <input type="email" className="p-3 flex-1 text-gray-800" placeholder="Sign in to our newsletter..." />
                ...
                <div className="md:w-[25%] w-full pt-8">
                    ...
                    <ul>
                        ...
                        <button className="py-2 text-fuchsia-600 mt-2">view more</button>
                    </ul>
                </div>
                ...
                <div className="md:w-[10%] w-full">
                    ...
                    <div className="flex justify-center items-start mt-5 text-gray-800">
                        <a href="https://facebook.com/" className="m-2 p-2 rounded bg-white"><FaFacebook /></a>
                        <a href="https://twitter.com/" className="m-2 p-2 rounded bg-white"><FaTwitter /></a>
                        <a href="https://instagram.com/" className="m-2 p-2 rounded bg-white"><FaInstagram /></a>
                    </div>
                </div>
            </div>
        </div>

    ...
    return (
        <div className="flex bg-slate-100 items-center px-[3%] py-1 justify-between">
            ...
            <ul className="flex items-center">
                ...
                <li className="px-3 py-1 hover:text-white hover:bg-fuchsia-600 rounded cursor-pointer">File</li>
                <li className="px-3 py-1 hover:text-white hover:bg-fuchsia-600 rounded cursor-pointer">Edit</li>
                <li className="px-3 py-1 hover:text-white hover:bg-fuchsia-600 rounded cursor-pointer">Infos</li>
                <li className="px-3 py-1 hover:text-white hover:bg-fuchsia-600 rounded cursor-pointer">Help</li>
